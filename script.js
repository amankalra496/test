...
let unmappedSKUs = []; // Track SKUs not found in skuToStockMapping
let multiItemPages = []; // Track pages with multiple order items
let contactInfo = []; // Track phone numbers and emails found
let printPreview = [];
let rajasthanOrders = []; 

let alwaysReplaceSkuWith = {
  "wine with flowers com set":"Wine Set",
  "8 pc lovely":"8 pc Vegas",
  "new triangle comforter set":"Berlin Set",
  "Grey patta + football (1+1)": "box +wb (1+1)",
  "2pc-box+lovely+navy+pista": "2pc-box+lovely+navy+leafora greens",
  "blue sunflower comforter set": "Leaves Set",
  "4 pc lovely": "4 pc Vegas",
  "grey lines fitted.": "Tokyo fitted",
  "6M-O2LU-0W8W": "WB fitted",
  "Pink Floral Fitted": "Pink Suprima Fitted",
  "blue flower fitted": "Pink Suprima Fitted",
  "blue flower 1+2 (heavy)": "Pink Suprima 1+2",
  "blue flower 60x78": "Pink Suprima 60x78",
  "blue flower 1+2||": "Pink Suprima 1+2",
  "blue flower 1+1||": "Pink Suprima 1+1",
  "pink flare 1+1 |": "Pink 1+1",
  "pink flare 1+2 |": "Pink 1+2",
  "Silver Sheet": "Silver 1+2",
  "Silver Single Sheet": "Silver 1+1",
  "Linear Single Sheet": "Linear 1+1",
  "Cube Sheet": "Cube 1+2",
  "Cube Single Sheet": "Cube 1+1",
  "Vintage Single Sheet": "Vintage 1+1",
  "Vintage Sheet": "Vintage 1+2",
  "Linear Sheet": "Linear 1+2",
  "brown diamond double dohr": "Dohar Pink Suprima",
  "brown diamond s/b fitted.": "Pink Suprima 36x78",
  "distorted double dohr": "Dohar Orchid Blue",
  "distorted lines s/b dohr": "Dohar Single Orchid Blue",
  "distorted dohr2pc": "Wine Dohr2Pc",
  "Blue Lehr Only": "Blue Lehr Com Only",
  "distorted com only": "Orchid Blue Com Only"
};
...
"Fitted Pink": 0,
"60x78 Norway": 0,
"Pillow Leafora Greens":0,
"Fitted Norway": 0,
"Fitted Pink Suprima": 0,
"Fitted BL": 0,
"60x78 BL": 0,
"1+2 BL": 0,
"1+1 BL": 0,
...
"Dohar Single Distorted": 0,
"Dohar Single Orchid Blue": 0,
...
"60x78 Ooonyx": 0,
"36x78 Ooonyx": 0,
"Dohar Pink Suprima": 0,
"36x78 Pink Suprima": 0,
"1+2 Jasper": 0,
"1+1 Jasper": 0,
"Dohar Single Jasper": 0,
"Dohar Jasper": 0,
"Pillow Jasper" : 0,
"Com Double Jasper": 0,
"Set Jasper": 0,
...
"1+2 Orchid Pink": 0,
"1+1 Orchid Pink": 0,
"Dohar Single Orchid Pink": 0,
"Dohar Orchid Pink": 0,
"Pillow Orchid Pink" : 0,
"Com Double Orchid Pink": 0,
"Set Orchid Pink": 0,
"Fitted Orchid Pink": 0,
"60x78 Orchid Pink": 0,
"36x78 Orchid Pink": 0,
"1+2 Orchid Green": 0,
"1+1 Orchid Green": 0,
"Dohar Single Orchid Green": 0,
"Dohar Orchid Green": 0,
"Pillow Orchid Green" : 0,
"Com Double Orchid Green": 0,
"Set Orchid Green": 0,
"Fitted Orchid Green": 0,
"60x78 Orchid Green": 0,
"36x78 Orchid Green": 0,
"1+2 Orchid Blue": 0,
"1+1 Orchid Blue": 0,
"Pillow Orchid Blue" : 0,
"Com Double Orchid Blue": 0,
"Set Orchid Blue": 0,
"Fitted Orchid Blue": 0,
"60x78 Orchid Blue": 0,
"36x78 Orchid Blue": 0,
"TC PL": 0,
"TC GL": 0,
...
"Fitted Solid Grey":0,
"Fitted Solid Plum":0,
"Fitted Solid Green":0,
"Fitted Solid Blue":0,
"Fitted Solid Red":0,
"Fitted Solid Black":0,
"Fitted Solid Charcoal":0,
"Fitted Hexa Brown":0,
"60x78 Hexa Brown":0,
"Fitted Hexa grey":0,
"60x78 Hexa grey":0,
"Fitted Mystic Wine":0,
"60x78 Mystic Wine":0,
"Fitted Mystic Grey":0,
"60x78 Mystic Grey":0,
"Pillow Solid Plum" : 0,
"Pillow Solid Green" : 0,
"Pillow Solid Black" : 0,
"Pillow Solid Blue Green" : 0,
"Pillow Solid Green Red" : 0,
"Pillow Solid Blue" : 0,
"Pillow Solid Red" : 0,
"Pillow Solid Charcoal" : 0,
"Pillow Solid Blue Red" : 0,
"Pillow Solid Grey" : 0
};
...
const skuToStockMapping = {
  ...
  "4pc - Solid Green": {
    "Pillow Solid Green": 4
  },
  "4pc - Solid Black": {
    "Pillow Solid Black": 4
  },
  "2pc - Solid Blue , Green": {
    "Pillow Solid Blue": 2,
    "Pillow Solid Green": 2
  },
  "2pc - Solid Green, Red": {
    "Pillow Solid Green": 2,
    "Pillow Solid Red": 2
  ...
  "2pc - Solid Charcoal": {
    "Pillow Solid Charcoal": 2
  },
  "2 pc - Solid Plum": {
    "Pillow Solid Plum": 2
  },
  "2pc - Solid Black": {
    "Pillow Solid Black": 2
  },
  "2 pc - Solid Grey": {
    "Pillow Solid Grey": 2
  },
  'Mystic Wine fitted': {
    "Fitted Mystic Wine": 1
  },
  'Mystic Wine 60x78': {
    "60x78 Mystic Wine": 1
  },
  'Mystic Grey fitted': {
    "Fitted Mystic Grey": 1
  },
  'Mystic Grey 60x78': {
    "60x78 Mystic Grey": 1
  },
  ...
  'Solid Black Fitted': {
    "Fitted Solid Black": 1
  },
  'Solid Charcoal Fitted': {
    "Fitted Solid Charcoal": 1
  },
  'Purple Fitted': {
    "Fitted Purple": 1
  },
  ...
  'brown diamond s/b fitted.': {
    "36x78 Pink Suprima": 1
  },
  'Vintage Fitted': {
    "Fitted Vintage": 1
  },
...
'box+pista 1+1': {
  ...
  'Orchid Pink s/b dohar': {
    "Dohar Single Orchid Pink": 1
  },
  'Orchid Pink dohar': {
    "Dohar Orchid Pink": 1
  },
  'Orchid Pink dohr2Pc': {
    "Dohar Orchid Pink": 1,
    "Pillow Orchid Pink" : 2
  },
  'Orchid Pink Com Only': {
    "Com Double Orchid Pink": 1
  },
  'Orchid Pink Set': {
    "Set Orchid Pink": 1
  },
  'Orchid Pink Fitted': {
    "Fitted Orchid Pink": 1
  },
  'Orchid Pink 60x78': {
    "60x78 Orchid Pink": 1
  },
  ...
  'Orchid Green s/b dohar': {
    "Dohar Single Orchid Green": 1
  },
  'Orchid Green dohar': {
    "Dohar Orchid Green": 1
  },
  'Orchid Green dohr2Pc': {
    "Dohar Orchid Green": 1,
    "Pillow Orchid Green" : 2
  },
  'Orchid Green Com Only': {
    "Com Double Orchid Green": 1
  },
  'Orchid Green Set': {
    "Set Orchid Green": 1
  },
  'Orchid Green Fitted': {
    "Fitted Orchid Green": 1
  },
  'Orchid Green 60x78': {
    "60x78 Orchid Green": 1
  },
  'Orchid Green 36x78': {
    "36x78 Orchid Green": 1
  },
  'Orchid Green 1+2': {
    "1+2 Orchid Green": 1
  },
  ...
  '4pc - Orchid Green': {
    "Pillow Orchid Green": 4
  },
  '6pc - Orchid Green': {
    "Pillow Orchid Green": 4
  },
  '8pc - Orchid Green': {
    "Pillow Orchid Green": 8
  },
  '2pc - Orchid Green': {
    "Pillow Orchid Green": 2
  },
  '6 pc Orchid Pink': {
    "Pillow Orchid Pink": 6
  },
  '2 pc Orchid Pink': {
    "Pillow Orchid Pink": 2
  },
  '4 pc Orchid Pink': {
    "Pillow Orchid Pink": 4
  },
  '8 pc Orchid Pink': {
    "Pillow Orchid Pink": 8
  },
  '8pc - Orchid Blue': {
    "Pillow Orchid Blue": 8
  },
  '6pc - Orchid Blue': {
    "Pillow Orchid Blue": 6
  },
  '2pc - Orchid Blue': {
    "Pillow Orchid Blue": 2
  },
  '4pc - Orchid Blue': {
    "Pillow Orchid Blue": 4
  },
  'Orchid Blue Fitted': {
    "Fitted Orchid Blue": 1
  },
  'Orchid Blue 36x78': {
    "36x78 Orchid Blue": 1
  },
  ...
  '2pc-Orchid Green,Blue,Pink': {
    "Pillow Orchid Green": 2,
    "Pillow Orchid Blue": 2,
    "Pillow Orchid Pink": 2
  },
  'Blue AB Com Only': {
    "Com Double Blue AB": 1
  },
  'Red AB Com Only': {
    "Com Double Red AB": 1
  },
  'Grey AB Com Only': {
    "Com Double Grey AB": 1
  },
  'Green AB Com Only': {
    "Com Double Green AB": 1
  },
  'Blue AB doharr': {
    "Dohar Blue AB": 1
  },
...
async function processPDF() {
  ...
  for (let i = 1; i < pdfJsDoc.numPages; i += 2) {
    ...
    if (text.toLowerCase().includes('rajasthan')) {
      // Extract shipping address
      const shipToMatch = text.match(/Shipping Address\s*:\s*([\s\S]*?)(?=State\/UT Code:|Place of supply:|$)/i);
      let addressText = 'Rajasthan Order'; // fallback
      
      if (shipToMatch) {
        addressText = shipToMatch[1].trim().replace(/\s+/g, ' ');
      }
      
      rajasthanOrders.push({
        page: i + 1,
        orderItems: [...orderItemsOnThisPage],
        addressText: addressText // Add this field
      });
    }

    
    // const phoneRegex = /(?:\+91|91)?[-.\s]?[6-9]\d{9}|\b\d{10}\b/g;
    const phoneRegex = /(?:\+91|91)?[-.\s]*[5-9]\d{9}|\b[5-9]\d{9}\b/g;
    ...
    if (phoneMatches) {
      phoneMatches.forEach(phone => {
        ...
        if (cleanPhone.length >= 10 && !contactInfo.some(c => c.value === cleanPhone)) {
          // Extract full shipping details for phone numbers
        const shipToMatch = text.match(/Shipping Address\s*:\s*([\s\S]*?)(?=State\/UT Code:|Place of supply:|$)/i);
          let fullDetails = '';
          
          if (shipToMatch) {
            fullDetails = shipToMatch[1].trim().replace(/\s+/g, ' ');
          }
          ...
          contactInfo.push({
            ...
            orderItems: [...orderItemsOnThisPage] // Copy order items from this page
          });
        }
      });
    }
    ...
    if (emailMatches) {
      emailMatches.forEach(email => {
        if (!contactInfo.some(c => c.value === email.toLowerCase())) {
          contactInfo.push({
            type: 'Email',
            value: email.toLowerCase(),
            page: i + 1,
            fullDetails: '', // No full details for email
            orderItems: [...orderItemsOnThisPage] // Copy order items from this page
          });
        }
      });
    ...
    if (orderItemsOnThisPage.length > 0) {
      ...
      if (barcodePage) {
        ...
        if (orderItemsOnThisPage.length > 1) {
           multiItemPages.push({
            page: i + 1,
            items: orderItemsOnThisPage
          });

          // Multiple order items on this specific page - print 'Multi' ONLY
          if (orderItemsOnThisPage.length === 2) {
            // Exactly 2 items - print both with smaller font
            const item1 = orderItemsOnThisPage[0];
            const item2 = orderItemsOnThisPage[1];

            const displaySku1 = alwaysReplaceSkuWith[item1.sku] || item1.sku;
            const displaySku2 = alwaysReplaceSkuWith[item2.sku] || item2.sku;
            
            const text1 = `${item1.qty} * ${displaySku1}`;
            const text2 = `${item2.qty} * ${displaySku2}`;
           
            printPreview.push({
              pageNumber: barcodePageIndex + 1,
              printText: `${text1}\n${text2}`,
              isMultiLine: true
            });
    
            console.log(`Placing two items: "${text1}" and "${text2}" with smaller font size at page number : ${barcodePageIndex}`);
          } else if (orderItemsOnThisPage.length === 3) {
            // Exactly 2 items - print both with smaller font
            const item1 = orderItemsOnThisPage[0];
            const item2 = orderItemsOnThisPage[1];
            const item3 = orderItemsOnThisPage[2];

             // Apply SKU replacement if exists
            const displaySku1 = alwaysReplaceSkuWith[item1.sku] || item1.sku;
            const displaySku2 = alwaysReplaceSkuWith[item2.sku] || item2.sku;
            const displaySku3 = alwaysReplaceSkuWith[item3.sku] || item3.sku;
            
             const text1 = `${item1.qty} * ${displaySku1}`;
             const text2 = `${item2.qty} * ${displaySku2}`;
             const text3 = `${item3.qty} * ${displaySku3}`;
            ...
            console.log(`Placing three items: >>  "${text1}" and "${text2}" and "${text3}" with smaller font size at page number : ${barcodePageIndex}`);
          }
          else {
            // More than 2 items - print 'Multi'
            insertText = 'Multi';
            fontSize = 16;
           ...
           else if (orderItemsOnThisPage.length === 1) {
              const item = orderItemsOnThisPage[0];
              const displaySku = alwaysReplaceSkuWith[item.sku] || item.sku;
             
              printPreview.push({
                pageNumber: barcodePageIndex + 1,
                printText: `${item.qty} * ${displaySku}`,
                isMultiLine: false
            });
             }
           else {
    ...
    else if (orderItemsOnThisPage.length === 0) {
      printPreview.push({
        pageNumber: barcodePageIndex + 1,
        printText: '', // Empty text for pages with no items
        isMultiLine: false
      });      
    }
  } 
  
  window.currentPdfDoc = pdfLibDoc;
  window.currentPages = pages;

  // Display final stock array
  displayStockArray();
  displayPrintPreview();
  displayRajasthanOrders();
...
async function downloadPDF() {
  if (!window.currentPdfDoc || !window.currentPages) {
    alert('Please process a PDF first');
    return;
  }

  // Check if printPreview exists and has content
  if (!printPreview || printPreview.length === 0) {
    alert('PDF is not correct - No barcode pages found');
    return;
  }

  const hasEmptyPages = printPreview.some(item => {
    const trimmedText = item.printText.trim();
    return trimmedText.length === 0;
  });

  if (hasEmptyPages) {
    alert('PDF is not correct - Some barcode pages have no items to print');
    return;
  }
  ...
  try {
    // Get updated text values from textareas before drawing
    const updatedPrintPreview = printPreview.map((printData, index) => {
      const textarea = document.getElementById(`printText_${index}`);
      if (textarea) {
        return {
          ...printData,
          printText: textarea.value // Use the current value from textarea
        };
      }
      return printData;
    });

    // Draw the actual text on pages based on UPDATED printPreview data
    for (const printData of updatedPrintPreview) {
      const pageIndex = printData.pageNumber - 1;
      const page = window.currentPages[pageIndex];
      
      if (page) {
        const font = await window.currentPdfDoc.embedFont(PDFLib.StandardFonts.HelveticaBold);
        const textY = 180;
        const textX = 60;
        
        if (printData.isMultiLine) {
          // Handle multi-line text
          const lines = printData.printText.split('\n');
          lines.forEach((line, lineIndex) => {
            if (line.trim()) { // Only draw non-empty lines
              page.drawText(line, {
                x: textX + (lines.length === 2 ? 310 : 310),
                y: textY + 5 - (lineIndex * 20),
                size: 14,
                font: font,
                color: PDFLib.rgb(0, 0, 0)
              });
          ...
          if (printData.printText.trim()) { // Only draw non-empty text
            page.drawText(printData.printText, {
              x: textX,
              y: textY,
              size: printData.printText === 'Multi' ? 16 : 20,
              font: font,
              color: PDFLib.rgb(0, 0, 0)
            });
          }
...
function displayPrintPreview() {
  const printPreviewDiv = document.getElementById('printPreviewResults');
...
// if(isAuthorized){
  if (printPreview.length > 0) {
    let previewHtml = `
      <div style="overflow-x: auto; overflow-y: auto; max-height: 500px; border: 1px solid rgba(0,255,200,0.2); border-radius: 10px;">
        <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
          <thead style="position: sticky; top: 0; background: rgba(20, 20, 40, 0.95); backdrop-filter: blur(10px);">
            <tr style="background: rgba(0,255,200,0.1);">
              <th style="padding: 12px; border: 1px solid rgba(0,255,200,0.3); color: #00f2fe;">Page Number</th>
              <th style="padding: 12px; border: 1px solid rgba(0,255,200,0.3); color: #00f2fe;">Print Text</th>
            </tr>
          </thead>
          <tbody>
    `;

    printPreview.forEach((item, index) => {
      previewHtml += `
        <tr>
          <td style="padding: 12px; border: 1px solid rgba(0,255,200,0.2); color: #e0f7ff; text-align: center; font-weight: bold;">
            ${item.pageNumber}
          </td>
          <td style="padding: 12px; border: 1px solid rgba(0,255,200,0.2);">
            <textarea 
              id="printText_${index}" 
              onchange="updatePrintText(${index}, this.value)"
              style="width: 100%; min-height: ${item.isMultiLine ? '80px' : '40px'}; background: rgba(255,255,255,0.05); color: #e0f7ff; border: 1px solid rgba(0,255,200,0.3); border-radius: 5px; padding: 8px; font-family: monospace; resize: vertical;"
            >${item.printText}</textarea>
          </td>
        </tr>
      `;
    });
    ...
    printPreviewDiv.classList.add('show');
  }
  //} 
  // else {
  //   printPreviewDiv.classList.remove('show');
  // }
}


function updatePrintText(index, newText) {
  if (printPreview[index]) {
    printPreview[index].printText = newText;
  }
}
...
function displayStockArray() {
  ...
  const sortOrder = [
    "1+1", "1+2", "108", "TC", "Fitted", "60x78", "36x78", "72x72",
  ...
  if (filteredStock.length === 0) {
    ...
    if (isAuthorized) {
      ...
      const unmappedDiv = document.getElementById('unmappedResults');
      const unmappedContent = document.getElementById('unmappedContent');

    if (unmappedSKUs.length > 0) {
      let unmappedHtml = '';
      unmappedSKUs.forEach(item => {
        unmappedHtml += `<div class="stock-item">
          <span class="stock-name">${item.sku}</span>
          <span class="stock-quantity">Qty: ${item.qty} | Page: ${item.page}</span>
        </div>`;
      });
      
      unmappedContent.innerHTML = unmappedHtml;
      unmappedDiv.classList.add('show');
    } else {
      unmappedDiv.classList.remove('show');
    }

    // Display Multi-Item Pages in separate section
    const multiItemDiv = document.getElementById('multiItemResults');
    const multiItemContent = document.getElementById('multiItemContent');

    if (multiItemPages.length > 0) {
      let multiItemHtml = '';
      multiItemPages.forEach(pageData => {
        multiItemHtml += `<div class="page-section" style="margin-bottom: 20px;">
          <h5 style="color: #00f2fe; margin-bottom: 10px;">Page ${pageData.page}:</h5>
        `;
        
        pageData.items.forEach(item => {
          multiItemHtml += `<div class="stock-item">
            <span class="stock-name">${item.sku}</span>
            <span class="stock-quantity">Qty: ${item.qty}</span>
          </div>`;
        });
      ...
      multiItemContent.innerHTML = multiItemHtml;
      multiItemDiv.classList.add('show');

      const contactDiv = document.getElementById('contactResults');
      const contactContent = document.getElementById('contactContent');

          if (contactInfo.length > 0) {
              let contactHtml = '';
              contactInfo.forEach(contact => {
                const icon = contact.type === 'Phone' ? 'fas fa-phone' : 'fas fa-envelope';
                
                if (contact.type === 'Phone') {
                  // For phone numbers, show full details
                  contactHtml += `<div class="contact-section" style="margin-bottom: 20px; padding: 15px; background: rgba(0,255,200,0.05); border-radius: 10px;">
                    <div style="color: #00f2fe; font-weight: bold; margin-bottom: 10px;">
                      <i class="${icon}"></i> Phone: ${contact.value} | Page: ${contact.page}
                    </div>
                    ${contact.fullDetails ? `<div style="color: #e0f7ff; margin-bottom: 10px; font-size: 0.9em;">${contact.fullDetails}</div>` : ''}
                    <div style="color: #a8b2d1; font-weight: bold;">Ordered Items:</div>
                  `;
                  
                  if (contact.orderItems && contact.orderItems.length > 0) {
                    contact.orderItems.forEach(item => {
                      contactHtml += `<div class="stock-item" style="margin-top: 5px;">
                        <span class="stock-name">${item.sku}</span>
                        <span class="stock-quantity">Qty: ${item.qty}</span>
                      </div>`;
                    });
                  } else {
                    contactHtml += `<div style="color: #a8b2d1; font-style: italic;">No order items found</div>`;
                  }
                  
                  contactHtml += `</div>`;
                } else {
                  // For emails, show only email and order items
                  contactHtml += `<div class="contact-section" style="margin-bottom: 20px; padding: 15px; background: rgba(0,255,200,0.05); border-radius: 10px;">
                    <div style="color: #00f2fe; font-weight: bold; margin-bottom: 10px;">
                      <i class="${icon}"></i> Email: ${contact.value} | Page: ${contact.page}
                    </div>
                    <div style="color: #a8b2d1; font-weight: bold;">Ordered Items:</div>
                  `;
        ...
        multiItemDiv.classList.remove('show');
    }
        } else {
        ...
        html += `
          <div class="copy-section">
            <h4><i class="fas fa-copy"></i>Result</h4>
...
function displayRajasthanOrders() {

    const passwordInput = document.getElementById('passwordInput');
    const userPassword = passwordInput ? passwordInput.value.trim() : '';
    const isAuthorized = userPassword === 'Radhasoami';
    const rajasthanDiv = document.getElementById('rajasthanResults');
    const rajasthanContent = document.getElementById('rajasthanContent');

    if(isAuthorized){     
     if (rajasthanOrders.length > 0) {
        let rajasthanHtml = '';
          rajasthanOrders.forEach(order => {
            rajasthanHtml += `<div class="contact-section" style="margin-bottom: 20px; padding: 15px; background: rgba(0,255,200,0.05); border-radius: 10px;">
            <div style="color: #00f2fe; font-weight: bold; margin-bottom: 10px;">
              <i class="fas fa-map-marker-alt"></i> ${order.addressText} | Page: ${order.page}
            </div>
            <div style="color: #a8b2d1; font-weight: bold;">Ordered Items:</div>
          `;
          ...
          if (order.orderItems && order.orderItems.length > 0) {
            order.orderItems.forEach(item => {
              rajasthanHtml += `<div class="stock-item" style="margin-top: 5px;">
                <span class="stock-name">${item.sku}</span>
                <span class="stock-quantity">Qty: ${item.qty}</span>
              </div>`;
            });
          } else {
            rajasthanHtml += `<div style="color: #a8b2d1; font-style: italic;">No order items found</div>`;
          }
          
          rajasthanHtml += `</div>`;
        });
        
        rajasthanContent.innerHTML = `<div style="max-height: 400px; overflow-y: auto; overflow-x: hidden;">${rajasthanHtml}</div>`;
        rajasthanDiv.classList.add('show');
      } else {
        rajasthanDiv.classList.remove('show');
      }
    }
    else {
     rajasthanDiv.classList.remove('show');
